...
export default function MailForm() {
    ...
    return (
        <form ref={formRef} onSubmit={sendEmail} className="mail-form flex flex-col gap-2.5">
            <div className="flex flex-col w-full gap-2.5 lg:flex-row">
                <Input
                    ...
                    className="mail-form__cont flex-1"
                />
                <Input
                    name="email"
                    placeholder="이메일"
            ...
            <Textarea
                ...
                showCharCount={true}
                maxLength={500}
                className="mail-form__cont"
            />

            <Button type="submit" loading={status === 'loading'} className="mail-form__btn ">
                제출
            </Button>
