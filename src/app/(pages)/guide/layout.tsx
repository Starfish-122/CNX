...
export default function GuidePageLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="container mx-auto   flex flex-col md:flex-row min-h-screen">
            {/* 사이드바 */}
            <div className="w-full md:w-64 mt-4 md:mt-10 h-auto md:h-full flex flex-col bg-gray-50 dark:bg-gray-900 border-b md:border-r border-gray-200 dark:border-gray-700">
