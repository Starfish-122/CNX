...
export default function TitleGuide() {
    return (
        <GuideLayout
            ...
            description={
                <>
                    <CodeTag>Text</CodeTag>는 텍스트를 일관된 스타일로 출력하는 컴포넌트입니다.{' '}
                    <br />
                    <CodeTag>element</CodeTag> 속성으로 p, span, div 태그를 지정할 수 있으며, <br />
                    <CodeTag>className</CodeTag> 속성으로 추가 커스텀 클래스 또는 tailwind 클래스를
                    지정할 수 있습니다.
                </>
            }
        >
            <GuideSection title="기본 사용">
                <ExampleCard demo={<Text>텍스트 내용</Text>} code={`<Text>텍스트 내용</Text>`} />
            </GuideSection>
            ...
            <GuideSection title="다양한 태그 사용">
                <ExampleCard
                    demo={
                        <div>
                            <Text className="bg-blue-200 dark:bg-blue-800" element="span">
                                span 태그 1
                            </Text>
                            <Text className="bg-red-200 dark:bg-red-800" element="span">
                                span 태그 2
                            </Text>
                            <Text className="bg-yellow-200 dark:bg-yellow-800" element="div">
                                div 태그
                            </Text>
                ...
                <ExampleCard
                    demo={
                        <div className="space-y-4">
                            ...
                            <Text className="bg-blue-100 dark:bg-blue-800">
                                텍스트 배경 색상 추가
                            </Text>
                        </div>
                    }
