...
export default function TitleGuide() {
    return (
        <GuideLayout
            ...
            description={
                <>
                    <CodeTag>Title</CodeTag>은 페이지/섹션 타이틀을 일관된 스타일로 출력하는
                    컴포넌트입니다. <br />
                    <CodeTag>element</CodeTag> 속성으로 HTML 태그/커스텀 컴포넌트를 지정할 수
                    있으며, <br />
        ...
        >
            <GuideSection title="기본 사용">
                <ExampleCard demo={<Title>섹션 제목</Title>} code={`<Title>섹션 제목</Title>`} />
            </GuideSection>
