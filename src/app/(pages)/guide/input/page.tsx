        ...
        <GuideLayout
            ...
            description={
                <>
                    ...
                    <CodeTag>label</CodeTag>, <CodeTag>hint</CodeTag>, <CodeTag>error</CodeTag>{' '}
                    메시지를 포함하며, <br />
                    <CodeTag>startAdornment</CodeTag>, <CodeTag>endAdornment</CodeTag>로 아이콘이나
                    버튼을 추가할 수 있습니다.
                </>
            }
        >
            <GuideSection title="기본 사용">
                <ExampleCard demo={<Input />} code={`<Input />`} />
            </GuideSection>
