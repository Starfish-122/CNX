...
export default function TagsGuide(): React.JSX.Element {
    return (
        <GuideLayout
            ...
            description={
                <>
                    <CodeTag>Tag</CodeTag>는 팔레트를 받아 렌더링하는 단순한{' '}
                    <b>프레젠테이션 전용</b> 컴포넌트,
                    <br />
                    <CodeTag>CategoryTag</CodeTag>는 카테고리 → 색상 매핑 컴포넌트입니다.
                    <br />
                    <CodeTag>TagList</CodeTag>로 여러 태그들을 묶어 간격/줄바꿈을 제어할 수
                    있습니다.
                </>
            }
        >
            ...
            <GuideSection title="Props">
                ...
                <PropsTable
                    rows={[
                        ...
                        {
                            prop: 'category',
                            type: `'Status' | 'Location' | 'PartySize' | ..`,
                            def: '(optional)',
                            desc: '카테고리',
                        },
                        { prop: 'disabled', type: 'boolean', def: 'false', desc: '비활성화' },
